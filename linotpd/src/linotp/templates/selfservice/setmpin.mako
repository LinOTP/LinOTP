...
<div id='passwordform'>
    <form class="cmxform" name='myForm'>
        ...
        <td><input type='password' autocomplete=off onkeyup="checkpins('#mpin1,#mpin2');" name="pin1" id='mpin1' class="text ui-widget-content ui-corner-all"/></td>
        </tr>
        <tr>
        <td><label for=pin2>${_("repeat mOTP PIN")}</label></td>
        <td><input type='password' autocomplete=off onkeyup="checkpins('#mpin1,#mpin2');" name="pin2" id='mpin2' class="text ui-widget-content ui-corner-all"/></td>
        </tr>
        </table>
