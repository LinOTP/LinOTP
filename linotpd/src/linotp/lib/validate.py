...
class ValidateToken(object):
    ...
    def check_token(self, passw, user, options=None):
        """
        ...
        challenges = self._get_challenges(options)
    ...
    def check_challenges(self, challenges, user, passw, options=None):
        ...
        for del_challenge in to_be_deleted:
            if '.' in del_challenge.transid:
                ...
                related_challenges = Challenges.get_challenges(self.context,
                                                    transid=tran_id)
                self.related_challenges.extend(related_challenges)

        Challenges.delete_challenges(serial=self.token.getSerial(),
    ...
    def check_standard(self, passw, user, options=None):
        ...
        try:
            ...
            if (support_challenge_response is True and
                    self.token.is_challenge_request(passw, user,
                                                    options=options)):
    ...
    def _get_challenges(self, options=None):
        """
