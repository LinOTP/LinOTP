...
class TestChunkConfigCase(unittest.TestCase):
    ...
    @patch('linotp.lib.config._storeConfigEntryDB', storeConfigEntryDB)
    def test_chunked_config(self):
        ...
        from linotp.lib.config import MAX_VALUE_LEN
    ...
    @patch('linotp.lib.config._storeConfigEntryDB', storeConfigEntryDB)
    @patch('linotp.lib.config.Session')
    ...
    @patch('linotp.lib.config.encryptPassword')
    @patch('linotp.lib.config._storeConfigEntryDB', storeConfigEntryDB)
    @patch('linotp.lib.config.Session')
