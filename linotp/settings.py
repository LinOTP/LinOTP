...
_config_schema = ConfigSchema(
    [
        ...
        ConfigItem(
            ...
            bytes,
            convert=bytes.fromhex,
            default=bytes.fromhex("c98a1039a41015243473f2c4c40bac71"),
            help=(
                "Salt used in the PBKDF2 function for the JWT_SECRET_KEY. "
                "This must be given as bytes or as a string "
                "consisting of hexadecimal digits, and should "
                "ideally contain 16 bytes or more of random data. There is a "
                "hard-coded default which you will want to replace if "
                "you are interested in security. If JWT_SECRET_SALT is "
                "empty, a random byte string will be generated by LinOTP; "
                "this will be different every time LinOTP is restarted, "
                "which will invalidate any outstanding JWTs."
            ),
        ),
        ConfigItem(
