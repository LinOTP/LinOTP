...
class HelpdeskController(BaseController, SessionCookieMixin):
    ...
    def users(self):
        ...
        try:
            ...
            # We need to return 'page', 'total', 'rows'
            res = {"page": int(page), "total": userNum, "rows": lines}
    ...
    def enroll(self):
        ...
        try:
            ...
            params["::scope::"] = {"helpdesk": True, "user": user}
    ...
    def setPin(self):
        ...
        try:
            ...
            for token in tokens:
                ...
                checkPolicyPre("admin", method="set", param=params, user=owner)
                ...
                info = {
                    "message": (
                        "A new pin ${Pin} has been set for your "
                        "token: ${serial}"
                    ),
