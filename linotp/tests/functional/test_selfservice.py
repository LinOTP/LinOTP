...
class TestSelfserviceController(TestController):
    ...
    def test_reset(self):
        ...
        response = self.make_userselfservice_request(
            "reset", auth_user=auth_user, params={"serial": "reset01"}
        )
        print(response)
        assert '"status": true' in response
        ...
        response = self.make_validate_request(
            "check",
            params={"user": "passthru_user1@myDefRealm", "pass": "secret"},
        )
        print(response)
        assert '"value": true' in response

        response = self.make_selfservice_request("reset", auth_user=auth_user)
        print(response)
    ...
    def test_resync(self):
        ...
        response = self.make_userselfservice_request(
            "resync",
            auth_user=auth_user,
            params={"serial": "XXXX", "otp1": "359864", "otp2": "348448"},
        )
        print(response)
        assert '"status": false' in response
        ...
        response = self.make_userselfservice_request(
            "resync",
            auth_user=auth_user,
            params={"serial": "token01", "otp1": "885497", "otp2": "696793"},
        )
        print(response)
        assert '"status": true' in response
        assert '"resync Token": true' in response

        response = self.make_selfservice_request("resync", auth_user=auth_user)
        print(response)
    ...
    def test_setmpin(self):
        ...
        response = self.make_userselfservice_request(
            "setmpin",
            auth_user=auth_user,
            params={"serial": "token01", "pin": "1234"},
        )
        print(response)
        assert '"status": true' in response
    ...
    def test_setpin(self):
        ...
        response = self.make_userselfservice_request(
            "setpin",
            auth_user=auth_user,
            params={"serial": "spass01", "pin": "1234"},
        )
        print(response)
        assert '"status": false' in response
        assert (
        ...
        response = self.make_userselfservice_request(
            "setpin",
            auth_user=auth_user,
            params={"serial": "spass01", "userpin": "secretPin"},
        )
        print(response)
        assert '"status": true' in response
        assert '"set userpin": 1' in response
        ...
        response = self.make_validate_request(
            "check",
            params={"user": "passthru_user1@myDefRealm", "pass": "secretPin"},
        )
        print(response)
        assert '"status": true' in response
        assert '"value": true' in response

        response = self.make_selfservice_request("setpin", auth_user=auth_user)
        print(response)
        assert "<div id='passwordform'>" in response
    ...
    def test_get_serial_by_otp(self):
        ...
        response = self.make_userselfservice_request(
            "getSerialByOtp",
            auth_user=auth_user,
            params={"type": "hmac", "otp": "885497"},
        )
        print(response)
        assert '"status": false' in response
        assert (
            '"message": "ERR410: The policy settings do not allow you to request a serial by OTP!"'
            in response
        )
        ...
        response = self.make_admin_request(
            "tokenrealm", params={"serial": "token01", "realms": "myDefRealm"}
        )
        print(response)
    ...
    def test_assign(self):
        ...
        response = self.make_userselfservice_request(
            "assign", auth_user=auth_user, params={"serial": "token01"}
        )
        ...
        # unassign
        response = self.make_userselfservice_request(
            "unassign", auth_user=auth_user, params={"serial": "token01"}
        )
        print(response)
        assert (
            '"message": "ERR410: The policy settings do not allow you to issue this request!"'
        ...
        # UI
        response = self.make_selfservice_request("assign", auth_user=auth_user)
        print(response)
    ...
    def test_delete(self):
        ...
        response = self.make_userselfservice_request(
            "delete", auth_user=auth_user, params={"serial": "token01"}
        )
        print(response)
        assert (
            '"message": "ERR410: The policy settings do not allow you to issue this request!"'
        ...
        # UI
        response = self.make_selfservice_request("delete", auth_user=auth_user)
        print(response)
    ...
    def test_disable(self):
        ...
        response = self.make_userselfservice_request(
            "disable", auth_user=auth_user, params={"serial": "token01"}
        )
        print(response)
        assert (
            '"message": "ERR410: The policy settings do not allow you to issue this request!"'
        ...
        response = self.make_userselfservice_request(
            "enable", auth_user=auth_user, params={"serial": "token01"}
        )
        print(response)
        assert (
            '"message": "ERR410: The policy settings do not allow you to issue this request!"'
        ...
        response = self.make_selfservice_request("enable", auth_user=auth_user)
        print(response)
    ...
    def test_privilege_escalation_fix(self):
        ...
        response = self.make_userselfservice_request(
            "context", auth_user=auth_user, params={"user": "hans"}
        )
