...
setup(
    ...
    message_extractors={
        "linotp": [
            ...
            ("public/js/manage.js", "javascript", None),
            ("public/js/tools.js", "javascript", None),
            ("public/js/selfservice.js", "javascript", None),
            ("public/js/linotp_utils.js", "javascript", None),
            ("public/**", "ignore", None),
        ]
    },
    zip_safe=False,
